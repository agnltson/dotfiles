...
vim.api.nvim_set_hl(0, "Constant",   { fg = c.purple_2 })
...
vim.api.nvim_set_hl(0, "Function",   { fg = c.yellow_2, bold = true })
vim.api.nvim_set_hl(0, "Statement",  { fg = c.red_2, bold = true })
vim.api.nvim_set_hl(0, "Conditional",{ fg = c.red_2, bold = true })
vim.api.nvim_set_hl(0, "Repeat",     { fg = c.red_2 })
vim.api.nvim_set_hl(0, "Operator",   { fg = c.fg_1 })
vim.api.nvim_set_hl(0, "PreProc",    { fg = c.cyan_2 })
vim.api.nvim_set_hl(0, "Type",       { fg = c.blue_2 })
vim.api.nvim_set_hl(0, "Special",    { fg = c.magenta_2 })
...
-- ========== Treesitter ==========
vim.api.nvim_set_hl(0, "@function", { fg = c.yellow_2 })
vim.api.nvim_set_hl(0, "@variable", { fg = c.fg_2 })
vim.api.nvim_set_hl(0, "@keyword", { fg = c.red_2, bold = true })
vim.api.nvim_set_hl(0, "@string", { fg = c.green_2 })
vim.api.nvim_set_hl(0, "@number", { fg = c.purple_2 })
vim.api.nvim_set_hl(0, "@boolean", { fg = c.purple_2 })
vim.api.nvim_set_hl(0, "@comment", { fg = c.fg_0, italic = true })
vim.api.nvim_set_hl(0, "@type", { fg = c.blue_2 })
vim.api.nvim_set_hl(0, "@type.builtin", { fg = c.blue_2 })
vim.api.nvim_set_hl(0, "@constant", { fg = c.purple_2 })
vim.api.nvim_set_hl(0, "@operator", { fg = c.fg_1 })
